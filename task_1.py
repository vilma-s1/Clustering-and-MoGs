...
for i in range(0, len(phoneme_id)):
    if phoneme_id[i] == 1:  # checks if the phoneme is phoneme 1
        X_phoneme_1[j, :] = X_full[i, :]  # stores phoneme 1 data samples in X_phoneme_1
        j += 1  # counter for the rows in X_phoneme_1
